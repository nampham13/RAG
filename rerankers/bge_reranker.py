...
class BGEV2Reranker(IReranker):
    ...
    def __init__(
        ...
        self.model_name = model_name or os.getenv("BGE_V2_MODEL", "intfloat/bge-small-en")
    ...
    def _embed_texts(self, texts: Iterable[str]) -> torch.Tensor:
        all_embeds = []
        with torch.no_grad():
    ...
    def rerank(self, query: str, candidates: List[Dict[str, Any]], top_k: int = 5) -> List[Dict[str, Any]]:
        ...
        if q_emb.numel() == 0 or self._embeddings.numel() == 0:
            return []
